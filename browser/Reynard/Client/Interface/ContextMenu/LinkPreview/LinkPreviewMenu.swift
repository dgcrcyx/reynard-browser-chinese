    ...
    static func configuration(
        ...
        return UIContextMenuConfiguration(identifier: url as NSURL) { [url] in
            ...
            UIMenu(title: "", children: [
                ...
                UIAction(title: "在新隐私标签页中打开", image: UIImage(named: "reynard.plus.square.on.square")) { _ in
                    openInNewPrivateTab()
                },
                UIAction(title: "复制链接", image: UIImage(named: "reynard.document.on.document")) { _ in
