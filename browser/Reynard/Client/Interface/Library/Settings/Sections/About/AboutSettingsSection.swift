...
struct AboutSettingsSection {
    ...
    func cell(at index: Int) -> UITableViewCell {
        ...
        case .appVersion:
            ...
            return valueCell(title: "Reynard 浏览器", value: "\(version) (\(build))")
        case .engineVersion:
            return valueCell(title: "引擎版本", value: GeckoRuntime.version)
        case .sourceCode:
            return linkCell(title: "查看源代码")
        case .supportProject:
            return linkCell(title: "支持本项目")
        case .githubProfile:
