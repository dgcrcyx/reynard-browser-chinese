...
final class SettingsViewController: SettingsTableViewController {
    enum Section: Int, CaseIterable {
        ...
        var text: SettingsSectionText {
            switch self {
            case .updates:
                return SettingsSectionText(headerTitle: "可用更新")
            case .jit:
                return SettingsSectionText(headerTitle: "JIT 加速")
            case .general:
                return SettingsSectionText(headerTitle: "通用")
            case .privacy:
                return SettingsSectionText(headerTitle: "隐私")
            case .about:
                return SettingsSectionText(headerTitle: "关于")
            }
        }
    }
